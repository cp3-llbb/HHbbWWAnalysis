...
void compareSyncNtuples(const std::string & base_dir,
                        ...
                        const std::string & treeName)
{
  ...
  branchesToCompare.push_back(new branchEntryType("n_presel_ak4Jet", "I", "", 20, -0.5, 19.5));
  branchesToCompare.push_back(new branchEntryType("n_presel_ak8Jet", "I", "", 20, -0.5, 19.5));
  branchesToCompare.push_back(new branchEntryType("n_presel_ak8lsJet", "I", "", 20, -0.5, 19.5));
  ...
  branchesToCompare.push_back(new branchEntryType("n_loose_ak4BJet", "I", "", 10, -0.5, 9.5));
  branchesToCompare.push_back(new branchEntryType("n_medium_ak4BJet", "I", "", 10, -0.5, 9.5));
  branchesToCompare.push_back(new branchEntryType("is_resolved", "I", "", 2, -0.5, 1.5));
  branchesToCompare.push_back(new branchEntryType("is_boosted", "I", "", 2, -0.5, 1.5));
  branchesToCompare.push_back(new branchEntryType("is_semiboosted", "I", "", 2, -0.5, 1.5));

  branchesToCompare.push_back(new branchEntryType("mu1_isfakeablesel", "I", "n_presel_mu >= 1", 2, 0., 2.));
  branchesToCompare.push_back(new branchEntryType("mu1_ismvasel", "I", "n_presel_mu >= 1", 2, 0., 2.));
  ...
  branchesToCompare.push_back(new branchEntryType("mu2_isfakeablesel", "I", "n_presel_mu >= 1", 2, 0., 2.));
  branchesToCompare.push_back(new branchEntryType("mu2_ismvasel", "I", "n_presel_mu >= 1", 2, 0., 2.));
  ...
  branchesToCompare.push_back(new branchEntryType("ele1_isfakeablesel", "I", "n_presel_mu >= 1", 2, 0., 2.));
  branchesToCompare.push_back(new branchEntryType("ele1_ismvasel", "I", "n_presel_mu >= 1", 2, 0., 2.));
  ...
  branchesToCompare.push_back(new branchEntryType("ele2_isfakeablesel", "I", "n_presel_mu >= 1", 2, 0., 2.));
  branchesToCompare.push_back(new branchEntryType("ele2_ismvasel", "I", "n_presel_mu >= 1", 2, 0., 2.));
  ...
  branchesToCompare.push_back(new branchEntryType("ak4Jet1_pt", "F", "n_presel_ak4Jet >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet1_eta", "F", "n_presel_ak4Jet >= 1", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet1_phi", "F", "n_presel_ak4Jet >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak4Jet1_E", "F", "n_presel_ak4Jet >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet1_CSV", "F", "n_presel_ak4Jet >= 1", 100, 0., +1.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet1_btagSF", "F", "n_presel_ak4Jet >= 1", 50, 0.5, +2.));
  
  branchesToCompare.push_back(new branchEntryType("ak4Jet2_pt", "F", "n_presel_ak4Jet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet2_eta", "F", "n_presel_ak4Jet >= 2", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet2_phi", "F", "n_presel_ak4Jet >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak4Jet2_E", "F", "n_presel_ak4Jet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet2_CSV", "F", "n_presel_ak4Jet >= 2", 100, 0., +1.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet2_btagSF", "F", "n_presel_ak4Jet >= 2", 50, 0.5, +2.));
  
  branchesToCompare.push_back(new branchEntryType("ak4Jet3_pt", "F", "n_presel_ak4Jet >= 3", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet3_eta", "F", "n_presel_ak4Jet >= 3", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet3_phi", "F", "n_presel_ak4Jet >= 3", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak4Jet3_E", "F", "n_presel_ak4Jet >= 3", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet3_CSV", "F", "n_presel_ak4Jet >= 3", 100, 0., +1.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet3_btagSF", "F", "n_presel_ak4Jet >= 3", 50, 0.5, +2.));
  
  branchesToCompare.push_back(new branchEntryType("ak4Jet4_pt", "F", "n_presel_ak4Jet >= 4", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet4_eta", "F", "n_presel_ak4Jet >= 4", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak4Jet4_phi", "F", "n_presel_ak4Jet >= 4", 36, -TMath::Pi(), +TMath::Pi()));
  ...
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_phi", "F", "n_presel_ak8Jet >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_E", "F", "n_presel_ak8Jet >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_msoftdrop", "F", "n_presel_ak8Jet >= 1", 100, 0., +250.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_tau1", "F", "n_presel_ak8Jet >= 1", 100, 0., +0.7));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_tau2", "F", "n_presel_ak8Jet >= 1", 100, 0., +0.4));
  
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_subjet0_pt", "F", "n_presel_ak8Jet >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_subjet0_eta", "F", "n_presel_ak8Jet >= 1", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_subjet0_phi", "F", "n_presel_ak8Jet >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_subjet0_CSV", "F", "n_presel_ak8Jet >= 1", 100, 0., +1.));
  
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_subjet1_pt", "F", "n_presel_ak8Jet >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_subjet1_eta", "F", "n_presel_ak8Jet >= 1", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_subjet1_phi", "F", "n_presel_ak8Jet >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8Jet1_subjet1_CSV", "F", "n_presel_ak8Jet >= 1", 100, 0., +1.));
  
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_pt", "F", "n_presel_ak8Jet >= 2", 100, 150., 650.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_eta", "F", "n_presel_ak8Jet >= 2", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_phi", "F", "n_presel_ak8Jet >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_E", "F", "n_presel_ak8Jet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_msoftdrop", "F", "n_presel_ak8Jet >= 2", 100, 0., +250.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_tau1", "F", "n_presel_ak8Jet >= 2", 100, 0., +0.7));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_tau2", "F", "n_presel_ak8Jet >= 2", 100, 0., +0.4));
  
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_subjet0_pt", "F", "n_presel_ak8Jet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_subjet0_eta", "F", "n_presel_ak8Jet >= 2", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_subjet0_phi", "F", "n_presel_ak8Jet >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_subjet0_CSV", "F", "n_presel_ak8Jet >= 2", 100, 0., +1.));
  
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_subjet1_pt", "F", "n_presel_ak8Jet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_subjet1_eta", "F", "n_presel_ak8Jet >= 2", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_subjet1_phi", "F", "n_presel_ak8Jet >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8Jet2_subjet1_CSV", "F", "n_presel_ak8Jet >= 2", 100, 0., +1.));
  
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_pt", "F", "n_presel_ak8lsJet >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_eta", "F", "n_presel_ak8lsJet >= 1", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_phi", "F", "n_presel_ak8lsJet >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_E", "F", "n_presel_ak8lsJet >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_msoftdrop", "F", "n_presel_ak8lsJet >= 1", 100, 0., +250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_tau1", "F", "n_presel_ak8lsJet >= 1", 100, 0., +0.7));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_tau2", "F", "n_presel_ak8lsJet >= 1", 100, 0., +0.4));
  
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_subjet0_pt", "F", "n_presel_ak8lsJet >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_subjet0_eta", "F", "n_presel_ak8lsJet >= 1", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_subjet0_phi", "F", "n_presel_ak8lsJet >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_subjet0_CSV", "F", "n_presel_ak8lsJet >= 1", 100, 0., +1.));
  
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_subjet1_pt", "F", "n_presel_ak8lsJet >= 1", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_subjet1_eta", "F", "n_presel_ak8lsJet >= 1", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_subjet1_phi", "F", "n_presel_ak8lsJet >= 1", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet1_subjet1_CSV", "F", "n_presel_ak8lsJet >= 1", 100, 0., +1.));
  
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_pt", "F", "n_presel_ak8lsJet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_eta", "F", "n_presel_ak8lsJet >= 2", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_phi", "F", "n_presel_ak8lsJet >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_E", "F", "n_presel_ak8lsJet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_msoftdrop", "F", "n_presel_ak8lsJet >= 2", 100, 0., +250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_tau1", "F", "n_presel_ak8lsJet >= 2", 100, 0., +0.7));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_tau2", "F", "n_presel_ak8lsJet >= 2", 100, 0., +0.4));
  
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_subjet0_pt", "F", "n_presel_ak8lsJet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_subjet0_eta", "F", "n_presel_ak8lsJet >= 2", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_subjet0_phi", "F", "n_presel_ak8lsJet >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_subjet0_CSV", "F", "n_presel_ak8lsJet >= 2", 100, 0., +1.));
  
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_subjet1_pt", "F", "n_presel_ak8lsJet >= 2", 100, 0., 250.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_subjet1_eta", "F", "n_presel_ak8lsJet >= 2", 100, -3., +3.));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_subjet1_phi", "F", "n_presel_ak8lsJet >= 2", 36, -TMath::Pi(), +TMath::Pi()));
  branchesToCompare.push_back(new branchEntryType("ak8lsJet2_subjet1_CSV", "F", "n_presel_ak8lsJet >= 2", 100, 0., +1.));
