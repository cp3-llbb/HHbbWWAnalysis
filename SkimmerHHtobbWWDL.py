...
#            varsToKeep["met1_phi"] = self.corrMET.phi
            ...
            if self.is_MC:
                ...
                #    varsToKeep["weight_trigger_ee_sf_up"] = op.switch(op.rng_len(self.ElElTightSel)>0,
                #                                                      getVariation(self.lambda_ttH_doubleElectron_trigSF(self.ElElTightSel[0]),'ttH_doubleElectron_trigSFup'),
                #                                                      op.c_float(1.))
                #    varsToKeep["weight_trigger_ee_sf_down"] = op.switch(op.rng_len(self.ElElTightSel)>0,
                #                                                        getVariation(self.lambda_ttH_doubleElectron_trigSF(self.ElElTightSel[0]),'ttH_doubleElectron_trigSFdown'),
                #                                                        op.c_float(1.))
                #    varsToKeep["weight_trigger_mumu_sf_up"] = op.switch(op.rng_len(self.MuMuTightSel)>0,
                #                                                      getVariation(self.lambda_ttH_doubleMuon_trigSF(self.MuMuTightSel[0]),'ttH_doubleMuon_trigSFup'),
                #                                                      op.c_float(1.))
                #    varsToKeep["weight_trigger_mumu_sf_down"] = op.switch(op.rng_len(self.MuMuTightSel)>0,
                #                                                        getVariation(self.lambda_ttH_doubleMuon_trigSF(self.MuMuTightSel[0]),'ttH_doubleMuon_trigSFdown'),
                #                                                        op.c_float(1.))
                #    varsToKeep["weight_trigger_emu_sf_up"] = op.switch(op.rng_len(self.ElMuTightSel)>0,
                #                                                      getVariation(self.lambda_ttH_electronMuon_trigSF(self.ElMuTightSel[0]),'ttH_electronMuon_trigSFup'),
                #                                                      op.c_float(1.))
                #    varsToKeep["weight_trigger_emu_sf_down"] = op.switch(op.rng_len(self.ElMuTightSel)>0,
                #                                                        getVariation(self.lambda_ttH_electronMuon_trigSF(self.ElMuTightSel[0]),'ttH_electronMuon_trigSFdown'),
                #                                                        op.c_float(1.))
