...
class BtagReweightingRatio:
    def __init__(self, config, title, outputname, era):
        self.config     = config
        self.era        = era
        self.title      = title
    ...
    def plot(self):
        ...
        self.ratio.GetYaxis().SetRangeUser(0.5,1.0)
