...
class TemplateLatex:
    def __init__(self,dirpaths,logplot=False):
        ...
        self.variables = collections.OrderedDict([
                        ...
                        ("01DYnode_DNNOutputRebin_DY", "DNN 01 Output DY"),
                        ("01TTnode_DNNOutput_TT", "DNN 01 Output TT"),
                        ("01TTnode_DNNOutputRebin_TT", "DNN 01 Output TT"),
                        ("01Hnode_DNNOutput_H.", "DNN 01 Output H"),
                        ("01Hnode_DNNOutputRebin_H.", "DNN 01 Output H"),
                        ("01HHnode_DNNOutput_HH.", "DNN 01 Output HH"),
                        ("01HHnode_DNNOutputRebin_HH.", "DNN 01 Output HH"),
                        ("01STnode_DNNOutput_ST", "DNN 01 Output ST"),
                        ("01STnode_DNNOutputRebin_ST", "DNN 01 Output ST"),
                        ("01TTVXnode_DNNOutput_TTVX", "DNN 01 Output TTVX"),
                        ("01TTVXnode_DNNOutputRebin_TTVX", "DNN 01 Output TTVX"),
                        ("01VVVnode_DNNOutput_VVV", "DNN 01 Output VV(V)"),
                        ("01VVVnode_DNNOutputRebin_VVV", "DNN 01 Output VV(V)"),
                        ("02DYnode_DNNOutput_DY", "DNN 02 Output DY"),
                        ("02DYnode_DNNOutputRebin_DY", "DNN 02 Output DY"),
                        ("02TTnode_DNNOutput_TT", "DNN 02 Output TT"),
                        ("02TTnode_DNNOutputRebin_TT", "DNN 02 Output TT"),
                        ("02Hnode_DNNOutput_H.", "DNN 02 Output H"),
                        ("02Hnode_DNNOutputRebin_H.", "DNN 02 Output H"),
                        ("02HHnode_DNNOutput_HH.", "DNN 02 Output HH"),
                        ("02HHnode_DNNOutputRebin_HH.", "DNN 02 Output HH"),
                        ("02STnode_DNNOutput_ST", "DNN 02 Output ST"),
                        ("02STnode_DNNOutputRebin_ST", "DNN 02 Output ST"),
                        ("02TTVXnode_DNNOutput_TTVX", "DNN 02 Output TTVX"),
                        ("02TTVXnode_DNNOutputRebin_TTVX", "DNN 02 Output TTVX"),
                        ("02VVVnode_DNNOutput_VVV", "DNN 02 Output VV(V)"),
                        ("02VVVnode_DNNOutputRebin_VVV", "DNN 02 Output VV(V)"),
                        ("03DYnode_DNNOutput_DY", "DNN 03 Output DY"),
                        ("03DYnode_DNNOutputRebin_DY", "DNN 03 Output DY"),
                        ("03TTnode_DNNOutput_TT", "DNN 03 Output TT"),
                        ("03TTnode_DNNOutputRebin_TT", "DNN 03 Output TT"),
                        ("03Hnode_DNNOutput_H.", "DNN 03 Output H"),
                        ("03Hnode_DNNOutputRebin_H.", "DNN 03 Output H"),
                        ("03HHnode_DNNOutput_HH.", "DNN 03 Output HH"),
                        ("03HHnode_DNNOutputRebin_HH.", "DNN 03 Output HH"),
                        ("03STnode_DNNOutput_ST", "DNN 03 Output ST"),
                        ("03STnode_DNNOutputRebin_ST", "DNN 03 Output ST"),
                        ("03TTVXnode_DNNOutput_TTVX", "DNN 03 Output TTVX"),
                        ("03TTVXnode_DNNOutputRebin_TTVX", "DNN 03 Output TTVX"),
                        ("03VVVnode_DNNOutput_VVV", "DNN 03 Output VV(V)"),
                        ("03VVVnode_DNNOutputRebin_VVV", "DNN 03 Output VV(V)"),
                        ("04DYnode_DNNOutput_DY", "DNN 04 Output DY"),
                        ("04DYnode_DNNOutputRebin_DY", "DNN 04 Output DY"),
                        ("04TTnode_DNNOutput_TT", "DNN 04 Output TT"),
                        ("04TTnode_DNNOutputRebin_TT", "DNN 04 Output TT"),
                        ("04Hnode_DNNOutput_H.", "DNN 04 Output H"),
                        ("04Hnode_DNNOutputRebin_H.", "DNN 04 Output H"),
                        ("04HHnode_DNNOutput_HH.", "DNN 04 Output HH"),
                        ("04HHnode_DNNOutputRebin_HH.", "DNN 04 Output HH"),
                        ("04STnode_DNNOutput_ST", "DNN 04 Output ST"),
                        ("04STnode_DNNOutputRebin_ST", "DNN 04 Output ST"),
                        ("04TTVXnode_DNNOutput_TTVX", "DNN 04 Output TTVX"),
                        ("04TTVXnode_DNNOutputRebin_TTVX", "DNN 04 Output TTVX"),
                        ("04VVVnode_DNNOutput_VVV", "DNN 04 Output VV(V)"),
                        ("04VVVnode_DNNOutputRebin_VVV", "DNN 04 Output VV(V)"),
                        ])
