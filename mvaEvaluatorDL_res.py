...
def returnFatjetMVAInputs(self,fatjets):
    return {('fatjet_E',        'Fatjet E [GeV]',               (50,0.,500.))        : op.switch(op.rng_len(fatjets)>0, fatjets[0].p4.E(), op.c_float(0.)),
            ...
            ('fatjet_tau21',    'Fatjet #tau_21',               (50,0.,1.))          : op.switch(op.rng_len(fatjets)>0, fatjets[0].tau2/fatjets[0].tau1, op.c_float(0.)), 
            ('fatjet_tau32',    'Fatjet #tau_32',               (50,0.,1.))          : op.switch(op.rng_len(fatjets)>0, fatjets[0].tau3/fatjets[0].tau2, op.c_float(0.)),
            ('fatjet_tau43',    'Fatjet #tau_43',               (50,0.,1.))          : op.switch(op.rng_len(fatjets)>0, fatjets[0].tau4/fatjets[0].tau3, op.c_float(0.)), 
    ...
    return {
        ...
        ('min_dr_jets_lep2',       'Min(#Delta R(sublead lepton,jets))',      (25,0.,5.))       : op.switch(op.rng_len(jets) > 0,
                                                                                                            op.switch(l1conept(l1) >= l2conept(l2),
                                                                                                                      ...
                                                                                                                      self.HLL.MinDR_part1_partCont(l1,jets)),
                                                                                                            op.c_float(0.)),
        ('min_deta_jets_lep1',     'Min(#Delta Eta(lead lepton,jets))',       (25,0.,5.))       : op.switch(op.rng_len(jets) > 0,
                                                                                                            op.switch(l1conept(l1) >= l2conept(l2),
                                                                                                                      self.HLL.MinDEta_part1_partCont(l1,jets),
                                                                                                                      self.HLL.MinDEta_part1_partCont(l2,jets)),
                                                                                                            op.c_float(0.)),
        ('min_deta_jets_lep2',     'Min(#Delta Eta(sublead lepton,jets))',    (25,0.,5.))       : op.switch(op.rng_len(jets) > 0,
                                                                                                            op.switch(l1conept(l1) >= l2conept(l2),
                                                                                                                      self.HLL.MinDEta_part1_partCont(l2,jets),
                                                                                                                      self.HLL.MinDEta_part1_partCont(l1,jets)),
                                                                                                            op.c_float(0.)),
        ...
        ('deta_ll',                'Dilepton #Delta #Eta',                    (25,0.,5.))       : op.abs(l1.eta-l2.eta),
        ('min_dr_jet',             'Min(#Delta R(jets))',                     (25,0.,5.))       : op.switch(op.rng_len(dijets) > 0,
                                                                                                            ...
                                                                                                            op.c_float(0.)),
        ('min_deta_jet',           'Min(#Delta #Eta(jets))',                  (25,0.,5.))       : op.switch(op.rng_len(dijets) > 0,
                                                                                                            op.rng_min(dijets,lambda dijet : op.abs(dijet[0].eta-dijet[1].eta)),
                                                                                                            op.c_float(0.)),
        ('min_dphi_jet',           'Min(#Delta #Phi(jets))',                  (16,0.,3.2))      : op.switch(op.rng_len(dijets) > 0,
                                                                                                            rng_min(dijets,lambda dijet : op.abs(op.deltaPhi(dijet[0].p4,dijet[1].p4)),
                                                                                                                    typeName='double'),
                                                                                                            op.c_float(0.)),
        ...
        ('m_T',                     'Transverse mass',                        (100,0.,1000.))   : op.switch(op.rng_len(bjets) > 2,
                                                                                                            ...
                                                                                                            op.c_float(0.)),
        ('dr_lep1_dibjet',          'LeadingLepton-dibjet #Delta R',          (25,0.,5.))       : op.multiSwitch((op.rng_len(bjets) == 0, op.c_float(0.)),
                                                                                                                 (op.rng_len(bjets) == 1, op.switch(l1conept(l1) >= l2conept(l2),
                                                                                                                                                    op.deltaR(l1.p4,bjets[0].p4),
                                                                                                                                                    op.deltaR(l2.p4,bjets[0].p4))),
                                                                                                                 op.switch(l1conept(l1) >= l2conept(l2),
                                                                                                                           op.deltaR(l1.p4,(bjets[0].p4+bjets[1].p4)),
                                                                                                                           op.deltaR(l2.p4,(bjets[0].p4+bjets[1].p4)))),
        ('dr_lep2_dibjet',          'SubLeadingLepton-dibjet #Delta R',       (25,0.,5.))       : op.multiSwitch((op.rng_len(bjets) == 0, op.c_float(0.)),
                                                                                                                 (op.rng_len(bjets) == 1, op.switch(l1conept(l1) >= l2conept(l2),
                                                                                                                                                    op.deltaR(l2.p4,bjets[0].p4),
                                                                                                                                                    op.deltaR(l1.p4,bjets[0].p4))),
                                                                                                                 op.switch(l1conept(l1) >= l2conept(l2),
