...
def returnClassicInputs_2b1Wj(self, lep, jet1, jet2, jet3, jet4, VBFJetPairs):
    return{('era',                      'era',                      (3,2016,2019)): op.c_float(2016),
           ...
           ('HT2R_lepJetMet',           'HT2R_lepJetMet',           (50,0.,1.)):    self.HLL.HT2R_2b1Wj(lep,jet1,jet2,jet3,self.corrMET)}
...
def returnClassicInputs_2b0Wj(self, lep, jet1, jet2, jet3, jet4, VBFJetPairs):
    return{('era',                      'era',                      (3,2016,2019)): op.c_float(2016),
           ...
           ('HT2R_lepJetMet',           'HT2R_lepJetMet',           (50,0.,1.)):    self.HLL.HT2R_2b0Wj(lep,jet1,jet2,self.corrMET)}
...
def returnClassicInputs_1b2Wj(self, lep, jet1, jet2, jet3, jet4, VBFJetPairs):
    return{('era',                      'era',                      (3,2016,2019)): op.c_float(2016),
           ...
           ('minLepJetDR',              'minLepJetDR',              (50,0.,5.)):    self.HLL.MinDR_lep3j(lepton,jet1,jet3,jet4),
           ('HT2_lepJetMet',            'HT2_lepJetMet',            (50,0.,500.)):  self.HLL.HT2_1b2Wj(lepton,jet1,jet3,jet4,self.corrMET),
           ('HT2R_lepJetMet',           'HT2R_lepJetMet',           (50,0.,1.)):    self.HLL.HT2R_1b2Wj(lepton,jet1,jet3,jet4,self.corrMET)}
...
def returnClassicInputs_1b1Wj(self, lep, jet1, jet2, jet3, jet4, VBFJetPairs):
    return{('era',                      'era',                      (3,2016,2019)): op.c_float(2016),
           ...
           ('HT2R_lepJetMet',           'HT2R_lepJetMet',           (50,0.,1.)):    self.HLL.HT2R_1b1Wj(lep,jet1,jet3,self.corrMET)}
...
# ---------------------- 1b0Wj ----------------------- #
def returnClassicInputs_1b0Wj(self, lep, jet1, jet2, jet3, jet4, VBFJetPairs):
    return{('era',                      'era',                      (3,2016,2019)): op.c_float(random.choice([2016,2017,2018])),
           ...
           ('HT2R_lepJetMet',           'HT2R_lepJetMet',           (50,0.,1.)):    self.HLL.HT2R_1b0Wj(lep,jet1,self.corrMET)}
