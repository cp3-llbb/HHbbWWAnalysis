    ...
    def defineSkimSelection(self, t, noSel, sample=None, sampleCfg=None): 
        ...
        if not self.inclusive_sel:
            ...
            if self.args.Hbb0Wj:
                ...
                VBFJetPairsJPA = op.sort(op.combine(op.select(self.VBFJets, cleanVBFwithJPA_Boosted_rest()), N=2, pred=self.lambda_VBFPair),
                                         lambda dijet : -op.invariant_mass(dijet[0].p4,dijet[1].p4))
        ...
        if any([self.args.__dict__[item] for item in ["Ak4","Res2b2Wj","Res2b1Wj","Res2b0Wj","Res1b2Wj","Res1b1Wj","Res1b0Wj","Res0b"]]):
            ...
            varsToKeep['minDR_lep_allJets']  = self.HLL.MinDR_part1_partCont(lepton, self.ak4Jets) if not self.args.Res0b else op.static_cast("Float_t",op.c_float(0.))
            ...
            varsToKeep['HbbLepDR']          = op.deltaR(jet1.p4+jet2.p4, lepton.p4)          if has2b else op.static_cast("Float_t",op.c_float(0.)) ###
            varsToKeep['HbbLepDPhi']        = op.abs(op.deltaPhi(jet1.p4+jet2.p4, lepton.p4))if has2b else op.static_cast("Float_t",op.c_float(0.)) ###
            varsToKeep['HbbMetDPhi']        = op.abs(op.deltaPhi(jet1.p4+jet2.p4, MET.p4))   if has2b else op.static_cast("Float_t",op.c_float(0.)) ###
            ...
            varsToKeep['cosThetaS_Wjj_simple']    = op.extMethod("HHbbWWJPA::cosThetaS", returnType="float")(jet3.p4, jet4.p4)  if has2ndWjet else op.static_cast("Float_t",op.c_float(0.))
            varsToKeep['cosThetaS_WW_simple_met'] = op.extMethod("HHbbWWJPA::cosThetaS", returnType="float")(self.HLL.Wjj_simple(jet3.p4,jet4.p4), self.HLL.Wlep_met_simple(lepton.p4, MET.p4)) if has2ndWjet else op.static_cast("Float_t",op.c_float(0.))
            varsToKeep['cosThetaS_HH_simple_met'] = op.extMethod("HHbbWWJPA::cosThetaS", returnType="float")(self.HLL.bJetCorrP4(jet1)+self.HLL.bJetCorrP4(jet2), self.HLL.HWW_met_simple(jet3.p4,jet4.p4,lepton.p4,MET.p4)) if self.args.Res2b2Wj else op.static_cast("Float_t",op.c_float(0.))
        ...
        if any([self.args.__dict__[item] for item in ["Ak8","Hbb2Wj","Hbb1Wj","Hbb0Wj"]]):
            ...
            varsToKeep['fatbj_sub1pt']         = op.switch(jet1.pt > jet2.pt, jet1.pt, jet2.pt)
            varsToKeep['fatbj_sub1eta']        = op.switch(jet1.pt > jet2.pt, jet1.eta, jet2.eta)
            varsToKeep['fatbj_sub2pt']         = op.switch(jet1.pt > jet2.pt, jet2.pt, jet1.pt)
            varsToKeep['fatbj_sub2eta']        = op.switch(jet1.pt > jet2.pt, jet2.eta, jet1.eta)
            varsToKeep['fatbj_softdropMass']   = fatjet.msoftdrop
            varsToKeep['fatbj_tau1']           = fatjet.tau1 
            varsToKeep['fatbj_tau2']           = fatjet.tau2 
            varsToKeep['fatbj_tau3']           = fatjet.tau3 
            varsToKeep['fatbj_tau4']           = fatjet.tau4 
            varsToKeep['fatbj_tau43']          = op.static_cast("Float_t",(fatjet.tau4/fatjet.tau3))
            varsToKeep['fatbj_tau32']          = op.static_cast("Float_t",(fatjet.tau3/fatjet.tau2))
            varsToKeep['fatbj_tau21']          = op.static_cast("Float_t",(fatjet.tau2/fatjet.tau1))
            ...
            varsToKeep['cosThetaS_Hbb']     = op.extMethod("HHbbWWJPA::cosThetaS", returnType="float")(jet1.p4, jet2.p4)
            ...
            varsToKeep['fatbjSub1_lepDR']   = op.switch(jet1.pt > jet2.pt, op.deltaR(jet1.p4, lepton.p4), op.deltaR(jet2.p4, lepton.p4))
            varsToKeep['fatbjSub2_lepDR']   = op.switch(jet1.pt > jet2.pt, op.deltaR(jet2.p4, lepton.p4), op.deltaR(jet1.p4, lepton.p4))
            varsToKeep['fatbj_lepDPhi']     = op.abs(op.deltaPhi(fatjet.p4, lepton.p4))
            varsToKeep['fatbjSub1_lepDPhi'] = op.switch(jet1.pt > jet2.pt, op.abs(op.deltaPhi(jet1.p4, lepton.p4)), op.abs(op.deltaPhi(jet2.p4, lepton.p4)))
            varsToKeep['fatbjSub2_lepDPhi'] = op.switch(jet1.pt > jet2.pt, op.abs(op.deltaPhi(jet2.p4, lepton.p4)), op.abs(op.deltaPhi(jet1.p4, lepton.p4)))
            ...
            varsToKeep["WWplaneAngle"] = self.HLL.angleBetPlanes(lepton.p4,self.HLL.neuP4(jet3.p4+jet4.p4+lepton.p4, MET),jet3.p4, jet4.p4) \
                                         if self.args.Hbb2Wj else op.static_cast("Float_t",op.c_float(0.)) 
            varsToKeep["WWplaneAngle_withMET"] = self.HLL.angleWWplane(lepton.p4, MET, jet3.p4, jet4.p4) if self.args.Hbb2Wj else op.static_cast("Float_t",op.c_float(0.))
            ...
            varsToKeep['HWW_Mass']        = op.extMethod("HHbbWWJPA::HWW_SimpleMassWithRecoNeutrino", returnType="float")(jet3.p4, jet4.p4, lepton.p4, MET.p4)  if self.args.Hbb2Wj else op.static_cast("Float_t",op.c_float(0.))
            ...
            varsToKeep['cosThetaS_Wjj_simple']    = op.extMethod("HHbbWWJPA::cosThetaS", returnType="float")(jet3.p4, jet4.p4)  if self.args.Hbb2Wj else op.static_cast("Float_t",op.c_float(0.))
